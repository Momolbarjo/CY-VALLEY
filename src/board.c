...
void randomizer(int map[SIZE][SIZE]) {
  ...
  for (int i = 0; i < 15; i++) {
    ...
    }while((map[rocks_x][rocks_y] != '.' && map[rocks_x][rocks_y] != '@')&& (map[rocks_x-1][rocks_y] != '.' && map[rocks_x-1][rocks_y] != '@')&& (map[rocks_x+1][rocks_y] != '.' && map[rocks_x+1][rocks_y] != '@')  );
  ...
  for (int i = 0; i < 12; i++) {
    ...
    }while((map[houses_x][houses_y] != '.' && map[houses_x][houses_y] != '@')&& (map[houses_x-1][houses_y] != '.' && map[houses_x-1][houses_y] != '@')&& (map[houses_x+1][houses_y] != '.' && map[houses_x+1][houses_y] != '@') );
 ...
 for (int i = 0; i < 20; i++) {
    ...
    }while((map[woods_x][woods_y] != '.' && map[woods_x][woods_y] != '@') && (map[woods_x-1][woods_y] != '.' && map[woods_x-1][woods_y] != '@')&& (map[woods_x+1][woods_y] != '.' && map[woods_x+1][woods_y] != '@') );
...
for (int i = 0; i < 12; i++) {
 ...
 do {
  ...
  } while ((map[sword_x][sword_y] != '.' && map[sword_x][sword_y] != '@') && (map[sword_x-1][sword_y] != '.' && map[sword_x-1][sword_y] != '@') && (map[sword_x+1][sword_y] != '.' && map[sword_x+1][sword_y] != '@') );
  map[sword_x][sword_y] = '*';

 do {
  shield_x=rand() % (SIZE - 6) + 3;
  shield_y=rand() % (SIZE - 6) + 3;
  } while ((map[shield_x][shield_y] != '.' && map[shield_x][shield_y] != '@') && (map[shield_x-1][shield_y] != '.' && map[shield_x-1][shield_y] != '@') && (map[shield_x+1][shield_y] != '.' && map[shield_x+1][shield_y] != '@') );
  map[shield_x][shield_y] = '#';

 do {
        npc1_x=rand() % (SIZE - 20) + 10;
        npc1_y=rand() % (SIZE - 20) + 10;
  } while ((map[npc1_x][npc1_y] != '.' && map[npc1_x][npc1_y] != '@') && (map[npc1_x-1][npc1_y] != '.' && map[npc1_x-1][npc1_y] != '@')&& (map[npc1_x+1][npc1_y] != '.' && map[npc1_x+1][npc1_y] != '@') );
  map[npc1_x][npc1_y] = '=';
  
 do {
        npc2_x=rand() % (SIZE - 20) + 10;
        npc2_y=rand() % (SIZE - 20) + 10;
   } while ((map[npc2_x][npc2_y] != '.' && map[npc2_x][npc2_y] != '@') && (map[npc2_x-1][npc2_y] != '.' && map[npc2_x-1][npc2_y] != '@')&&(map[npc2_x+1][npc2_y] != '.' && map[npc2_x+1][npc2_y] != '@') );
  map[npc2_x][npc2_y] = '^';

 do {
        random_x = rand() % (SIZE - 6) + 3;
        random_y = rand() % (SIZE - 6) + 3;
    } while ((map[random_x][random_y] != '.' && map[random_x][random_y] != '@') && (map[random_x-1][random_y] != '.' && map[random_x-1][random_y] != '@') && (map[random_x+1][random_y] != '.' && map[random_x+1][random_y] != '@') );
 ...
 for (int i = 0; i < 10; i++) {
    ...
    } while ((map[ennemy_x][ennemy_y] != '.' && map[ennemy_x][ennemy_y] != '@') && (map[ennemy_x-1][ennemy_y] != '.' && map[ennemy_x-1][ennemy_y] != '@')&&(map[ennemy_x+1][ennemy_y] != '.' && map[ennemy_x+1][ennemy_y] != '@') ); 
